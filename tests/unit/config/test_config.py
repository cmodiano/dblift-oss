...
class TestDatabaseConfig:
    ...
    def test_create_from_url(self):
        """Test creating DatabaseConfig from native Oracle URL without credentials."""
        database_url = "oracle+oracledb://localhost:1521?service_name=XE"
    ...
    def test_create_from_url_with_properties(self):
        ...
        url = "oracle+oracledb://localhost:1521?service_name=XE&schema=public&ssl=true"
